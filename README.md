...
Zombie::Courier.es_and(tel: 18510705036, id: 11).select(:id, :tel).load
# => []
Zombie::Courier.es_where(tel: 18510705036, id: 11).select(:id, :tel).load
# => []
Zombie::Courier.es_and(tel: 18510705036, id: 7).select(:id, :tel).load
#=> [#<Zombie::Courier:0x007fa63e922b60 @id=[7], @tel=["18510705036"]>]
]
